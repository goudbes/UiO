public class OpioidPill extends Opioid implements Pill{
  ...
  */
  OpioidPill(String name, int identificationNumber, double price, int opioid,
  ...
  */
  ...
  public void info() {
    ...
    ", pille" + ", a, " + this.getPrice() +", " + this.getNumberOfPills() + ", " +
